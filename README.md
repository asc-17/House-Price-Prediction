...
A simple House Price Predictor to predict house price with just `area`(in sq.m) of a house. Prediction using linear regression model.

## Tech Stack Used
- **Frontend / Deployment**: Flask
